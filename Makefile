...
index.html: index_top.html jquery-3.4.1.min.js jquery-ui.min.js libmupdf_packaged.js combine.js index_btwn_js.html magickApi_packaged.js combine_module.js index_b4_css.html opt_common.css combine.css index_bot.html
	cat $^ > $@ 

clean:
	rm libmupdf_packaged.js magick_packaged.js magickApi_packaged.js index.html
